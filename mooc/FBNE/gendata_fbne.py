...
class Dataset(object):
    ...
    def generate_intra_users_2nd(self):
        ...
        with open('../Mooc_upstream/FBNE_intra_file/mooc_2nd_user_train_file.csv', 'r') as f:
            line = f.readline()
        ...
        with open('../Mooc_upstream/FBNE_intra_file/mooc_2nd_user_valid_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
    ...
    def generate_intra_users_3rd(self):
        train_user_dict, valid_user_dict = {}, {}
        with open('../Mooc_upstream/FBNE_intra_file/mooc_3rd_user_train_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                user, high_order_users = int(arr[0]), arr[1:]
        ...
        with open('../Mooc_upstream/FBNE_intra_file/mooc_3rd_user_valid_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                user, high_order_users = int(arr[0]), arr[1:]
    ...
    def generate_intra_items_2nd(self):
        ...
        with open('../Mooc_upstream/FBNE_intra_file/mooc_2nd_item_train_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
        ...
        with open('../Mooc_upstream/FBNE_intra_file/mooc_2nd_item_valid_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                item, high_order_items = int(arr[0]), arr[1:]
    ...
    def generate_intra_items_3rd(self):
        train_item_dict, valid_item_dict = {}, {}
        with open('../Mooc_upstream/FBNE_intra_file/mooc_3rd_item_train_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                item, high_order_items = int(arr[0]), arr[1:]
        ...
        with open('../Mooc_upstream/FBNE_intra_file/mooc_3rd_item_valid_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                item, high_order_items = int(arr[0]), arr[1:]
