...
class DataLoader(object):
    ...
    def _generate_padding_dict(self):
        ...
        with open('../Mooc_upstream/user_task/user_task_train_oracle_rating.csv', 'r') as f:
            line = f.readline()
        ...
        with open('../Mooc_upstream/user_task/user_task_valid_oracle_rating.csv', 'r') as f:
            line = f.readline()
            while line!="" and line!=None:
                arr = line.strip().split(',')
                user, item = int(arr[0]), int(arr[1])
        ...
        with open('../Mooc_downstream/mooc/user_task_meta_train.csv', 'r') as f:
            line = f.readline()
            while line!="" and line!=None:
                arr = line.strip().split(',')
                user, item = int(arr[0]), int(arr[1])
    ...
    def generate_intra_users_2nd(self):
        ...
        with open('./FBNE_intra_file/mooc_2nd_user_train_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                user, high_order_users = int(arr[0]), arr[1:-1]
        ...
        with open('./FBNE_intra_file/mooc_2nd_user_valid_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
        ...
        with open('./FBNE_intra_file_upstream/mooc_2nd_user_train_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                user, high_order_users = int(arr[0]), arr[1:-1]
        ...
        with open('./FBNE_intra_file_upstream/mooc_2nd_user_valid_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                user, high_order_users = int(arr[0]), arr[1:]
        ...
        for user in range(setting.num_users):
            if user not in train_user_dict.keys():
                train_user_dict[user] = []
                for _ in range(8):# 8 is intra length
    ...
    def generate_intra_users_3rd(self):
        train_user_dict, valid_user_dict = {}, {}
        with open('./FBNE_intra_file/mooc_3rd_user_train_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                user, high_order_users = int(arr[0]), arr[1:]
        ...
        with open('./FBNE_intra_file/mooc_3rd_user_valid_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                user, high_order_users = int(arr[0]), arr[1:]
        ...
        with open('./FBNE_intra_file_upstream/mooc_3rd_user_train_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                user, high_order_users = int(arr[0]), arr[1:]
        ...
        with open('./FBNE_intra_file_upstream/mooc_3rd_user_valid_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                user, high_order_users = int(arr[0]), arr[1:]
    ...
    def generate_intra_items_2nd(self):
        ...
        with open('./FBNE_intra_file/mooc_2nd_item_train_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
        ...
        with open('./FBNE_intra_file/mooc_2nd_item_valid_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                item, high_order_items = int(arr[0]), arr[1:]
        ...
        with open('./FBNE_intra_file_upstream/mooc_2nd_item_train_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                item, high_order_items = int(arr[0]), arr[1:]
        ...
        with open('./FBNE_intra_file_upstream/mooc_2nd_item_valid_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                item, high_order_items = int(arr[0]), arr[1:]
    ...
    def generate_intra_items_3rd(self):
        train_item_dict, valid_item_dict = {}, {}
        with open('./FBNE_intra_file/mooc_3rd_item_train_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                item, high_order_items = int(arr[0]), arr[1:]
        ...
        with open('./FBNE_intra_file/mooc_3rd_item_valid_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                item, high_order_items = int(arr[0]), arr[1:]
        ...
        with open('./FBNE_intra_file_upstream/mooc_3rd_item_train_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                item, high_order_items = int(arr[0]), arr[1:]
        ...
        with open('./FBNE_intra_file_upstream/mooc_3rd_item_valid_file.csv', 'r') as f:
            line = f.readline()
            while line != "" and line != None:
                arr = line.strip().split(',')
                item, high_order_items = int(arr[0]), arr[1:]
