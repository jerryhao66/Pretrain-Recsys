...
def evaluate(model, sess, test_batch):
    ...
    n_item_batchs = model.num_items // model.batch_size_item + 1
    ...
    for user_index in tqdm.tqdm(test_user_length):
        ...
        for i_batch_id in range(n_item_batchs):
            i_start = i_batch_id * model.batch_size_item
            i_end = min((i_batch_id + 1) * (model.batch_size_item), model.num_items)
