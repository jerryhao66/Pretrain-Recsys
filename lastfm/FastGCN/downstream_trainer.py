...
def evaluate(model, sess, test_batch):
    ...
    test_i_1st_user, test_i_2nd_item, test_i_3rd_user = test_batch

    precision, recall, ndcg, hit_ratio = [], [], [], []
    n_item_batchs = model.num_items // setting.batch_size_item + 1
    ...
    for user_index in tqdm.tqdm(test_user_length):
        ...
        for i_batch_id in range(n_item_batchs):
            i_start = i_batch_id * setting.batch_size_item
            i_end = min((i_batch_id + 1) * (setting.batch_size_item), model.num_items)
...
def revise_test_neighbors_item_task_downstream(name):
    ...
    with g_rl_revise.as_default():
        with sess3.as_default():
            ...
            num_batch = downstream_data.num_items // setting.batch_size_item
            ...
            trancated_item_input = item_input[num_batch * setting.batch_size_item:setting.num_items,:]
            ...
            trancated_i_1st_user = i_1st_user[num_batch * setting.batch_size_item:setting.num_items,:]
            ...
            trancated_i_2nd_item = i_2nd_item[num_batch * setting.batch_size_item:setting.num_items,:]
            ...
            trancated_i_3rd_user = i_3rd_user[num_batch * setting.batch_size_item:setting.num_items,:]
...
def revise_test_neighbors_user_task_downstream(name):
    ...
    with g_rl_revise.as_default():
        with sess3.as_default():
            ...
            num_batch = downstream_data.num_users // setting.batch_size_user
            ...
            trancated_user_input = user_input[num_batch * setting.batch_size_user:setting.num_users,:]
            ...
            trancated_u_1st_item = u_1st_item[num_batch * setting.batch_size_user:setting.num_users,:]
            ...
            trancated_u_2nd_user = u_2nd_user[num_batch * setting.batch_size_user:setting.num_users,:]
            ...
            trancated_u_3rd_item = u_3rd_item[num_batch * setting.batch_size_user:setting.num_users,:]
...
def train_downstream_task_revised(name):
    ...
    with g_rl_revise.as_default():
        with sess3.as_default():
            ...
            user_input, u_1st_item, u_2nd_user, u_3rd_item, \
            pos_item_input, ipos_1st_user, ipos_2nd_item, ipos_3rd_user, \
            neg_item_input, ineg_1st_user, ineg_2nd_item, ineg_3rd_user = data.get_train_instances_revised(
                train, 0)
            print('already load train...')

            batch_size = setting.batch_size_recommender
            batch_index = []
