...
class GeneralGNN(object):
    def __init__(self, name, sess):
        ...
        with tf.device('/gpu:0'):
            ...
            self.predict_u_2nd, self.batch_loss_2nd_user, self.loss_2nd_user, self.optimizer_2nd_user_task = self._2nd_user_task(
                name, self.support_user_2nd, self.support_item_1st, self.inter_support_2nd_user)

        with tf.device('gpu:1'):
            self.predict_u_3rd, self.batch_loss_3rd_user, self.loss_3rd_user, self.optimizer_3rd_user_task = self._3rd_user_task(
                name, self.support_item_3rd, self.support_user_2nd_, self.support_item_1st_, self.inter_support_3rd_user)
            ...
            self.predict_i_2nd_pos, self.batch_loss_2nd_item_pos, self.loss_2nd_item_pos, self.optimizer_2nd_item_task_pos = self._2nd_item_task(
                name, self.support_item_2nd_pos, self.support_user_1st_pos, self.inter_support_2nd_item_pos)
            self.predict_i_2nd_neg, self.batch_loss_2nd_item_neg, self.loss_2nd_item_neg, self.optimizer_2nd_item_task_neg = self._2nd_item_task(
                name, self.support_item_2nd_neg, self.support_user_1st_neg, self.inter_support_2nd_item_neg)
        ...
        with tf.device('gpu:2'):
            self.predict_i_3rd_pos, self.batch_loss_3rd_item_pos, self.loss_3rd_item_pos, self.optimizer_3rd_item_task_pos = self._3rd_item_task(
                name, self.support_user_3rd_pos, self.support_item_2nd_pos_, self.support_user_1st_pos_, self.inter_support_3rd_item_pos)
            ...
            self.predict_i_3rd_neg, self.batch_loss_3rd_item_neg, self.loss_3rd_item_neg, self.optimizer_3rd_item_task_neg = self._3rd_item_task(
                name, self.support_user_3rd_neg, self.support_item_2nd_neg_, self.support_user_1st_neg_, self.inter_support_3rd_item_neg)
    ...
    def _2nd_user_task(self, name, support_user_2nd, support_item_1st, inter_support_2nd_user):
    ...
    def _2nd_item_task(self, name, support_item_2nd, support_user_1st, inter_support_2nd_item):
    ...
    def _3rd_item_task(self, name, support_user_3rd, support_item_2nd_, support_user_1st_, inter_support_3rd_item):

        if name == 'FBNE':
            print('use FBNE')
            with tf.name_scope('FBNE_3rd_i'):
                with tf.variable_scope('FBNE_3rd_i', reuse=tf.AUTO_REUSE):
                    # target_item -> first-order user -> second-order item -> third-order user
    ...
    def _3rd_user_task(self, name, support_item_3rd, support_user_2nd_, support_item_1st_, inter_support_3rd_user):
