...
class GeneralGNN(object):
    def __init__(self, name, sess):
        ...
        # print(original_user_ebd.shape)
        # print(original_item_ebd.shape)
    ...
    def _2nd_pairwise_loss(self):
        ...
        self.second_w_neg = self.glorot(shape=[self.embedding_size, self.embedding_size], name='second_w_neg')
